          ...
          <div class="header-right">
            ...
            <div id="org-switcher-wrap" style="display:none; position:relative;">
              <button id="org-switcher-btn" style="
                ...
                background:rgba(var(--color-gold-rgb),0.08); border:1px solid rgba(var(--color-gold-rgb),0.25);
                border-radius:8px; padding:7px 12px; color:var(--color-gold);
              ...
              <div id="org-switcher-dropdown" style="
                ...
                border:1px solid rgba(var(--color-gold-rgb),0.2); border-radius:12px;
