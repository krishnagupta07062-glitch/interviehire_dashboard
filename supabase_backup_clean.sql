...
INSERT INTO public."JobRole" VALUES ('08ed817a-5e98-4083-a056-61ce569b48b5', 'cbc684c2-63f6-4a66-ab4e-4f795fbe97a3', 'Director, Product Management Enterprise Platforms & Core Infrastructure', 'GENERAL', 'QUORUM FINANCIAL GROUP Director, Product Management Enterprise Platforms & Core Infrastructure Â· New York, NY Â· Hybrid (3 days onsite) Reports to SVP of Product Â· Full-time Â· Posted June 2026 ABOUT THE ROLE Quorum is looking for a Director of Product Management to own our core enterprise platform â€” the backbone that processes $4B+ in daily transaction volume for 600 institutional clients. You will set the product vision for a surface that engineers care deeply about and that clients never see, which means your impact is measured in uptime, throughput, and the absence of 3am incidents. This is not a role for someone who wants to launch consumer features on a six-week cycle. You will spend a lot of time reading architecture RFCs, sitting in on SRE postmortems, and arguing with a very opinionated VP of Engineering about whether we should rewrite the order matching engine in Rust. You should find that prospect exciting. WHAT YOU''LL OWN Multi-year roadmap for core settlement, custody, and reconciliation infrastructure across equities, fixed income, and FX Product strategy for our internal developer platform: shared APIs, SDKs, and the tooling layer used by 12 product teams Quarterly OKR cycles for your pod â€” setting targets, tracking them rigorously, and being honest when something isn''t working Client advisory relationships with 8â€“10 Tier 1 institutional accounts; you will occasionally present roadmap directly to their CTOs Hiring, coaching, and leveling the four PMs who report to you; two are senior and opinionated, which is the point Cross-functional alignment across Compliance, Risk, and Legal on anything that touches regulatory reporting or capital requirements WHAT WE NEED FROM YOU 8+ years in product management, at least 3 in a senior/staff role owning platform or infrastructure products â€” not just features Ability to read a database schema and have a meaningful conversation about query performance; you don''t need to write the SQL, but you need to understand why it matters Experience in a regulated environment: fintech, banking, insurance, or similar; compliance is not a blocker to you, it is a design constraint Track record of deprecating things â€” our platform has 14 years of legacy and someone needs to make the hard calls Strong written communication; our engineering culture is async-first: Slack is for jokes, Notion is for decisions Comfort with ambiguity at the strategic level and zero tolerance for ambiguity at the execution level PREFERRED BUT NOT REQUIRED Background in financial services: trade lifecycle, clearing & settlement, or custody operations Prior experience managing other PMs, not just individual contributors MBA or CFA â€” not because we value credentials, but because it usually means rigorous thinking about capital allocation You''ve worked at a firm that had a serious production incident and came out of it having changed something structural, not just added a runbook INTERVIEW PROCESS 30-min intro call with talent (scheduling, logistics, soft fit) 60-min product sense interview with SVP of Product â€” expect a case set in financial infrastructure, not consumer 90-min technical depth interview with VP of Engineering and a Staff Engineer â€” no coding, but heavy on systems thinking Half-day onsite in Midtown: leadership panel, take-home case debrief, and a 30-min informal lunch with the team you''d join Reference calls, offer, done â€” we move in under three weeks if you do Quorum Financial Group is an equal opportunity employer. We do not discriminate on the basis of race, religion, national origin, gender, sexual orientation, age, disability, or veteran status.', 'QUORUM FINANCIAL GROUP Director, Product Management Enterprise Platforms & Core Infrastructure Â· New York, NY Â· Hybrid (3 days onsite) Reports to SVP of Product Â· Full-time Â· Posted June 2026 ABOUT THE ROLE Quorum is looking for a Director of Product Management to own our core enterprise platform â€” the backbone that processes $4B+ in daily transaction volume for 600 institutional clients. You will set the product vision for a surface that engineers care deeply about and that clients never see, which means your impact is measured in uptime, throughput, and the absence of 3am incidents. This is not a role for someone who wants to launch consumer features on a six-week cycle. You will spend a lot of time reading architecture RFCs, sitting in on SRE postmortems, and arguing with a very opinionated VP of Engineering about whether we should rewrite the order matching engine in Rust. You should find that prospect exciting. WHAT YOU''LL OWN Multi-year roadmap for core settlement, custody, and reconciliation infrastructure across equities, fixed income, and FX Product strategy for our internal developer platform: shared APIs, SDKs, and the tooling layer used by 12 product teams Quarterly OKR cycles for your pod â€” setting targets, tracking them rigorously, and being honest when something isn''t working Client advisory relationships with 8â€“10 Tier 1 institutional accounts; you will occasionally present roadmap directly to their CTOs Hiring, coaching, and leveling the four PMs who report to you; two are senior and opinionated, which is the point Cross-functional alignment across Compliance, Risk, and Legal on anything that touches regulatory reporting or capital requirements WHAT WE NEED FROM YOU 8+ years in product management, at least 3 in a senior/staff role owning platform or infrastructure products â€” not just features Ability to read a database schema and have a meaningful conversation about query performance; you don''t need to write the SQL, but you need to understand why it matters Experience in a regulated environment: fintech, banking, insurance, or similar; compliance is not a blocker to you, it is a design constraint Track record of deprecating things â€” our platform has 14 years of legacy and someone needs to make the hard calls Strong written communication; our engineering culture is async-first: Slack is for jokes, Notion is for decisions Comfort with ambiguity at the strategic level and zero tolerance for ambiguity at the execution level PREFERRED BUT NOT REQUIRED Background in financial services: trade lifecycle, clearing & settlement, or custody operations Prior experience managing other PMs, not just individual contributors MBA or CFA â€” not because we value credentials, but because it usually means rigorous thinking about capital allocation You''ve worked at a firm that had a serious production incident and came out of it having changed something structural, not just added a runbook INTERVIEW PROCESS 30-min intro call with talent (scheduling, logistics, soft fit) 60-min product sense interview with SVP of Product â€” expect a case set in financial infrastructure, not consumer 90-min technical depth interview with VP of Engineering and a Staff Engineer â€” no coding, but heavy on systems thinking Half-day onsite in Midtown: leadership panel, take-home case debrief, and a 30-min informal lunch with the team you''d join Reference calls, offer, done â€” we move in under three weeks if you do Quorum Financial Group is an equal opportunity employer. We do not discriminate on the basis of race, religion, national origin, gender, sexual orientation, age, disability, or veteran status.', '{topics}', '{communication,"system design"}', '{"primary": 0.4, "education": 0.1, "secondary": 0.3, "experience": 0.1, "communication": 0.1}', '{"reasoning": 1, "confidence": 1, "correctness": 1, "communication": 1, "modelAnswerAlignment": 1}', '2026-06-09 19:22:14.064551+05:30', '2026-06-09 19:22:14.064551+05:30');
INSERT INTO public."JobRole" VALUES ('1f0cf586-72d3-4637-bd26-ec6dbd63a90f', 'cbc684c2-63f6-4a66-ab4e-4f795fbe97a3', 'Director, Product Management Enterprise Platforms & Core Infrastructure', 'GENERAL', 'QUORUM FINANCIAL GROUP Director, Product Management Enterprise Platforms & Core Infrastructure Â· New York, NY Â· Hybrid (3 days onsite) Reports to SVP of Product Â· Full-time Â· Posted June 2026 ABOUT THE ROLE Quorum is looking for a Director of Product Management to own our core enterprise platform â€” the backbone that processes $4B+ in daily transaction volume for 600 institutional clients. You will set the product vision for a surface that engineers care deeply about and that clients never see, which means your impact is measured in uptime, throughput, and the absence of 3am incidents. This is not a role for someone who wants to launch consumer features on a six-week cycle. You will spend a lot of time reading architecture RFCs, sitting in on SRE postmortems, and arguing with a very opinionated VP of Engineering about whether we should rewrite the order matching engine in Rust. You should find that prospect exciting. WHAT YOU''LL OWN Multi-year roadmap for core settlement, custody, and reconciliation infrastructure across equities, fixed income, and FX Product strategy for our internal developer platform: shared APIs, SDKs, and the tooling layer used by 12 product teams Quarterly OKR cycles for your pod â€” setting targets, tracking them rigorously, and being honest when something isn''t working Client advisory relationships with 8â€“10 Tier 1 institutional accounts; you will occasionally present roadmap directly to their CTOs Hiring, coaching, and leveling the four PMs who report to you; two are senior and opinionated, which is the point Cross-functional alignment across Compliance, Risk, and Legal on anything that touches regulatory reporting or capital requirements WHAT WE NEED FROM YOU 8+ years in product management, at least 3 in a senior/staff role owning platform or infrastructure products â€” not just features Ability to read a database schema and have a meaningful conversation about query performance; you don''t need to write the SQL, but you need to understand why it matters Experience in a regulated environment: fintech, banking, insurance, or similar; compliance is not a blocker to you, it is a design constraint Track record of deprecating things â€” our platform has 14 years of legacy and someone needs to make the hard calls Strong written communication; our engineering culture is async-first: Slack is for jokes, Notion is for decisions Comfort with ambiguity at the strategic level and zero tolerance for ambiguity at the execution level PREFERRED BUT NOT REQUIRED Background in financial services: trade lifecycle, clearing & settlement, or custody operations Prior experience managing other PMs, not just individual contributors MBA or CFA â€” not because we value credentials, but because it usually means rigorous thinking about capital allocation You''ve worked at a firm that had a serious production incident and came out of it having changed something structural, not just added a runbook INTERVIEW PROCESS 30-min intro call with talent (scheduling, logistics, soft fit) 60-min product sense interview with SVP of Product â€” expect a case set in financial infrastructure, not consumer 90-min technical depth interview with VP of Engineering and a Staff Engineer â€” no coding, but heavy on systems thinking Half-day onsite in Midtown: leadership panel, take-home case debrief, and a 30-min informal lunch with the team you''d join Reference calls, offer, done â€” we move in under three weeks if you do Quorum Financial Group is an equal opportunity employer. We do not discriminate on the basis of race, religion, national origin, gender, sexual orientation, age, disability, or veteran status.', 'QUORUM FINANCIAL GROUP Director, Product Management Enterprise Platforms & Core Infrastructure Â· New York, NY Â· Hybrid (3 days onsite) Reports to SVP of Product Â· Full-time Â· Posted June 2026 ABOUT THE ROLE Quorum is looking for a Director of Product Management to own our core enterprise platform â€” the backbone that processes $4B+ in daily transaction volume for 600 institutional clients. You will set the product vision for a surface that engineers care deeply about and that clients never see, which means your impact is measured in uptime, throughput, and the absence of 3am incidents. This is not a role for someone who wants to launch consumer features on a six-week cycle. You will spend a lot of time reading architecture RFCs, sitting in on SRE postmortems, and arguing with a very opinionated VP of Engineering about whether we should rewrite the order matching engine in Rust. You should find that prospect exciting. WHAT YOU''LL OWN Multi-year roadmap for core settlement, custody, and reconciliation infrastructure across equities, fixed income, and FX Product strategy for our internal developer platform: shared APIs, SDKs, and the tooling layer used by 12 product teams Quarterly OKR cycles for your pod â€” setting targets, tracking them rigorously, and being honest when something isn''t working Client advisory relationships with 8â€“10 Tier 1 institutional accounts; you will occasionally present roadmap directly to their CTOs Hiring, coaching, and leveling the four PMs who report to you; two are senior and opinionated, which is the point Cross-functional alignment across Compliance, Risk, and Legal on anything that touches regulatory reporting or capital requirements WHAT WE NEED FROM YOU 8+ years in product management, at least 3 in a senior/staff role owning platform or infrastructure products â€” not just features Ability to read a database schema and have a meaningful conversation about query performance; you don''t need to write the SQL, but you need to understand why it matters Experience in a regulated environment: fintech, banking, insurance, or similar; compliance is not a blocker to you, it is a design constraint Track record of deprecating things â€” our platform has 14 years of legacy and someone needs to make the hard calls Strong written communication; our engineering culture is async-first: Slack is for jokes, Notion is for decisions Comfort with ambiguity at the strategic level and zero tolerance for ambiguity at the execution level PREFERRED BUT NOT REQUIRED Background in financial services: trade lifecycle, clearing & settlement, or custody operations Prior experience managing other PMs, not just individual contributors MBA or CFA â€” not because we value credentials, but because it usually means rigorous thinking about capital allocation You''ve worked at a firm that had a serious production incident and came out of it having changed something structural, not just added a runbook INTERVIEW PROCESS 30-min intro call with talent (scheduling, logistics, soft fit) 60-min product sense interview with SVP of Product â€” expect a case set in financial infrastructure, not consumer 90-min technical depth interview with VP of Engineering and a Staff Engineer â€” no coding, but heavy on systems thinking Half-day onsite in Midtown: leadership panel, take-home case debrief, and a 30-min informal lunch with the team you''d join Reference calls, offer, done â€” we move in under three weeks if you do Quorum Financial Group is an equal opportunity employer. We do not discriminate on the basis of race, religion, national origin, gender, sexual orientation, age, disability, or veteran status.', '{topics}', '{communication,"system design"}', '{"primary": 0.4, "education": 0.1, "secondary": 0.3, "experience": 0.1, "communication": 0.1}', '{"reasoning": 1, "confidence": 1, "correctness": 1, "communication": 1, "modelAnswerAlignment": 1}', '2026-06-09 22:07:00.957079+05:30', '2026-06-09 22:07:00.957079+05:30');
...
- Manage client advisory relationships with 8â€“10 Tier 1 institutional accounts; present roadmap to their CTOs.
...
- Manage relationships with 8â€“10 Tier 1 institutional clients, presenting roadmap to CTOs
